# template-python-analytics

A minimal, typed Python analytics template with `uv`, Ruff, mypy, pytest, pre-commit, GitHub Actions, and semantic-release wired together.

## Intended Use

Use this template for reproducible analysis, metric calculation, validation, and transformation workflows. The repository infrastructure is ready
...
Keep reusable Python code under `src/template_python_analytics/` and tests under `tests/`.
...
- project name: `template-python-analytics`
- package name: `template_python_analytics`
